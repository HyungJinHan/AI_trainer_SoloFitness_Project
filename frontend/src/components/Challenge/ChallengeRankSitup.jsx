  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        axios.post("http://localhost:8008/challengeranksitup").then((res) => {
          setRank(res.data);
          axios
            .post("http://localhost:8008/mychallengeranksitup", {
              Nickname: nickname,
            })
            .then((res) => {
              setMyrank(res?.data[0]);
              axios
                .post("http://localhost:8008/mychallengerankingsitup", {
                  Nickname: nickname,
                })
                .then((res) => {
            ...
            <div className="ChallengeRank_main_div" key={index}>
              ...
              <div className="ChallengeRank_main_total_text">
                ...
                <div className="ChallengeRank_main_name">
                  ...
                  <br />
                  {ranklist.CHALLENGE_SITUP_SCORE * 45}점
                </div>
              </div>
            </div>
          );
      ...
      <div className="ChallengeRank_my_rank">
        ...
        <div className="ChallengeRank_my_total_text">
          ...
          <div className="ChallengeRank_my_name">
            ...
            <br />
            {myrank?.CHALLENGE_SITUP_SCORE * 45}점
          </div>
        </div>
      </div>

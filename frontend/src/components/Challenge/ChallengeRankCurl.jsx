  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        axios.post("http://localhost:8008/challengerankcurl").then((res) => {
          setRank(res.data);
          axios
            .post("http://localhost:8008/mychallengerankcurl", {
              Nickname: nickname,
            })
            .then((res) => {
              setMyrank(res?.data[0]);
              axios
                .post("http://localhost:8008/mychallengerankingcurl", {
                  Nickname: nickname,
                })
                .then((res) => {
  ...
  return (
    <div>
      <div className="ChallengeRank_top">
        <div className="ChallengeRank_rank_text">덤벨컬 랭킹</div>
        <select
            ...
            <div className="ChallengeRank_main_div" key={index}>
              ...
              <div className="ChallengeRank_main_total_text">
                ...
                <div className="ChallengeRank_main_name">
                  ...
                  <br />
                  {ranklist.CHALLENGE_CURL_SCORE * 30}점
                </div>
              </div>
            </div>
          );
      ...
      <div className="ChallengeRank_my_rank">
        ...
        <div className="ChallengeRank_my_total_text">
          ...
          <div className="ChallengeRank_my_name">
            ...
            <br />
            {myrank?.CHALLENGE_CURL_SCORE * 30}점
          </div>
        </div>
      </div>

  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        axios.post("http://localhost:8008/challengerankpullup").then((res) => {
          setRank(res.data);
          axios
            .post("http://localhost:8008/mychallengerankpullup", {
              Nickname: nickname,
            })
            .then((res) => {
              setMyrank(res?.data[0]);
              axios
                .post("http://localhost:8008/mychallengerankingpullup", {
                  Nickname: nickname,
                })
                .then((res) => {
  ...
  return (
    <div>
      <div className="ChallengeRank_top">
        <div className="ChallengeRank_rank_text">풀업 랭킹</div>
        <select
            ...
            <div className="ChallengeRank_main_div" key={index}>
              ...
              <div className="ChallengeRank_main_total_text">
                ...
                <div className="ChallengeRank_main_name">
                  ...
                  <br />
                  {ranklist.CHALLENGE_PULLUP_SCORE * 100}점
                </div>
              </div>
            </div>
          );
      ...
      <div className="ChallengeRank_my_rank">
        ...
        <div className="ChallengeRank_my_total_text">
          ...
          <div className="ChallengeRank_my_name">
            ...
            <br />
            {myrank?.CHALLENGE_PULLUP_SCORE * 100}점
          </div>
        </div>
      </div>

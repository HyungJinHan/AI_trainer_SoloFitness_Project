...
function UserLogin() {
  ...
  return (
    <MainCenter>
      ...
      <br />
      <br />
      <img src={MainLogo} alt="undefind" width="60%" />
      <br />
      <br />
      <br />
      <div>
      ...
      <div className="UserLogin_error">{errorMassege}</div>
      <div>
        <input
      ...
      <div>
        <a href="http://localhost:3000/userjoin" className="UserLogin_link">
          처음이신가요?
        </a>
        <br />
        <br />
        <a href="http://localhost:3000/centerlogin" className="UserLogin_link">
          센터 로그인
        </a>
      </div>
    </MainCenter>
